            ...
            steps{
                script{                    
                    withAWS(credentials: 'my-cba-aws-credential', region: 'us-east-1') {
                        ...
                        s3Upload(pathStyleAccessEnabled: true, payloadSigningEnabled: true, file:'maven_project/target/my-app-1.0-SNAPSHOT.jar', bucket:'cba-jenkins bucket', path:'ci-demo/javaapp/myapp.jar')
                    }
                }
            }
        }
